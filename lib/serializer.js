...
const jsonrpc = module.exports = {
  ...
  request : function (id, method, params) {
    ...
    const errors = _validateMessageStructure('request', {
      id     : id,
      method : method,
      params : params
    })
  ...
  notification : function (method, params) {
    const errors = _validateMessageStructure('notification', {
      method : method,
      params : params
    })
  ...
  success : function (id, result) {
    const errors = _validateMessageStructure('success', {
      id     : id,
      result : result
    })
  ...
  error : function (id, errdata) {
    const errors = _validateMessageStructure('error', {
      id    : id,
      error : errdata
    })
